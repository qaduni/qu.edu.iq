...
* **Hugo Extended** — Content lives in `content/{ar,en}/` and configuration in `hogo.toml`.
* **Pagefind (≥ 1.5)** — Client-side search.
* **Sveltia CMS** — Available by default in the theme.
* **qu.theme** — Hugo theme included as a Hugo module.
